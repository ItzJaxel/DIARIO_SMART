...
export { ClassOptions, User, FetchOptions, LoginResponse, AgendaFilter, TalkOptions, Overview, Card, ContentElement, TermsAgreementResponse, setTermsAgreementResponse, readOptions, TokenStatus, TicketResponse, checkDocument, absences, readNotice, Grade, calendarDay, resetPassword, AgendaNotes, readNote, Term, RestFetchOptions, MinigameToken, Homeworks, MinigameScope, MinigameLeaderboard, SchoolCheck, Book, CourseBooks, SchoolBooksResponse, Notice, DidacticsItem, Folder, Content, colorType, Lesson, ApiResponse, };
